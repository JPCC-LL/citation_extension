...
chrome.tabs.query({currentWindow: true, active: true}, function (tabs) {
    ...
    editButton.addEventListener('click', function () {
        ...
        //Adds the div and buttons to be displayed and edited
        var defaultDiv = document.createElement('div');
        defaultDiv.innerHTML = generateEditInnerHtml('Author', 'author', citationData.author) +
        ...
        missingSection.appendChild(defaultDiv);
        ...
        submitDiv.addEventListener('click', function () {
            ...
            citationData.author = defaultDiv.getElementsByTagName('input')[0].value;
            citationData.publisher = defaultDiv.getElementsByTagName('input')[1].value;
            citationData.articleTitle = defaultDiv.getElementsByTagName('input')[2].value;
            citationData.datePublished = defaultDiv.getElementsByTagName('input')[3].value;
            citationData.webTitle = defaultDiv.getElementsByTagName('input')[4].value;
        ...
        articleTypeFunctions.tweet = function () {
            ...
            chrome.extension.getBackgroundPage().console.log('tweet');
        };
        articleTypeFunctions.video = function () {
            ...
            chrome.extension.getBackgroundPage().console.log('video');
        };
