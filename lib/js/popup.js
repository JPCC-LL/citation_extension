...
chrome.tabs.query({currentWindow: true, active: true}, function (tabs) {
    ...
    editButton.addEventListener('click', function () {
        ...
        authorDiv.innerHTML = "Author <input type=text class='author' style='width: 100%' value='" + citationData.author + "'>";
        missingSection.appendChild(authorDiv);
        var publisherDiv = document.createElement('div');
        publisherDiv.innerHTML = "Publisher <input type=text class='publisher' style='width: 100%' value='" + citationData.publisher + "'>";
        missingSection.appendChild(publisherDiv);
        var articleTitleDiv = document.createElement('div');
        articleTitleDiv.innerHTML = "Article Title <input type=text class='article-title' style='width: 100%' value='" + citationData.articleTitle + "'>";
        missingSection.appendChild(articleTitleDiv);
        var datePublishedDiv = document.createElement('div');
        datePublishedDiv.innerHTML = "Date Published <input type=text class='date-published' style='width: 100%' value='" + citationData.datePublished + "'>";
        missingSection.appendChild(datePublishedDiv);
        var webTitleDiv = document.createElement('div');
        webTitleDiv.innerHTML = "Web Title <input type=text class='web-title' style='width: 100%' value='" + citationData.webTitle + "'>";
