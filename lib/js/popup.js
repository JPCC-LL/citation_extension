...
chrome.tabs.query({currentWindow: true, active: true}, function (tabs) {
    ...
    editButton.addEventListener('click', function () {
        ...
        submitDiv.addEventListener('click', function () {
            ...
            citationData.author = articleDiv.getElementsByTagName('input')[0].value;
            citationData.publisher = articleDiv.getElementsByTagName('input')[1].value;
            citationData.articleTitle = articleDiv.getElementsByTagName('input')[2].value;
            citationData.datePublished = articleDiv.getElementsByTagName('input')[3].value;
            citationData.webTitle = articleDiv.getElementsByTagName('input')[4].value;
