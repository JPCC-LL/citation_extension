...
chrome.tabs.query({currentWindow: true, active: true}, function(tabs) {
		...
		$.ajax({url: url, success: function(data) {
            ...
            var pub = getPublisher(metaTags);
            var articleTitle = getArticleTitle(metaTags);
            var author = getAuthor(metaTags);
            var dataPublished = getDatePosted(metaTags);
            var accessDate = getAccessDate();
...
//Why is this needed when it is stored in the chrome.Tab property?
