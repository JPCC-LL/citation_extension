...
chrome.tabs.query({currentWindow: true, active: true}, function (tabs) {
    ...
    var citationData = {};
    citationData.accessDate = getAccessDate();
    ...
    $.ajax({
        url: webURL, success: function (data) {
            ...
            citationData.pubisher = getData(metaTags, "property", "article:publisher");
